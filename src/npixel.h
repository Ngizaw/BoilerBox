...
class Color {
    ...
    public:
        ...
        Color &setRGBW(uint8_t r, uint8_t g, uint8_t b, uint8_t w);
...
class NPixel {
    ...
    public:
        ...
        NPixel &setPixelRGBW(uint16_t pixel, uint8_t r, uint8_t g, uint8_t b, uint8_t w);
		NPixel &setPixel32(uint16_t pixel, uint32_t c);
        NPixel &clear();
        NPixel &show();
